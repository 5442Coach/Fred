...
public class RobotMap {
    ...
    public static Encoder encodersQuadratureEncoderLeft;
    public static Encoder encodersQuadratureEncoderRight;
    ...
    public static void init() {
        ...
        encodersQuadratureEncoderLeft = new Encoder(0, 1, false, EncodingType.k4X);
        LiveWindow.addSensor("Encoders", "Quadrature Encoder Left", encodersQuadratureEncoderLeft);
        encodersQuadratureEncoderLeft.setSamplesToAverage(5);
        encodersQuadratureEncoderLeft.setDistancePerPulse(1.0/360);
        encodersQuadratureEncoderLeft.setPIDSourceParameter(PIDSourceParameter.kDistance);
        encodersQuadratureEncoderRight = new Encoder(2, 3, false, EncodingType.k4X);
        LiveWindow.addSensor("Encoders", "Quadrature EncoderRight", encodersQuadratureEncoderRight);
        encodersQuadratureEncoderRight.setSamplesToAverage(5);
        encodersQuadratureEncoderRight.setDistancePerPulse(1.0/360);
        encodersQuadratureEncoderRight.setPIDSourceParameter(PIDSourceParameter.kDistance);
