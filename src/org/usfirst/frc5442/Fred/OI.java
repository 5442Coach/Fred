...
public class OI {
	...
	public JoystickButton joystickLeftTriggerIn;
	public JoystickButton joystickRightTriggerIn;
    ...
    public OI() {
        ...
        joystickRightTriggerIn = new JoystickButton(joystickRight, 1);
        joystickRightTriggerIn.whileHeld(new winchMove());
        ...
        SmartDashboard.putData("ChooseDriveMode", new ChooseDriveMode());
